...
public class RingSelectAdapter extends ArrayAdapter<Map<String, String>> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.ringName.setText(map.get(AlarmClockCommon.RING_NAME));
        if (mRingName.equals(map.get(AlarmClockCommon.RING_NAME))) {
            // 设置标记图标
            ...
            RingSelectItem.getInstance()
                    .setUrl(map.get(AlarmClockCommon.RING_URL));
        } else {
            // 清除标记图标
